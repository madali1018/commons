package com.mada.commons.demo.cglib.demo4;

import com.mada.commons.demo.cglib.demo1.TargetObject;
...
public class InterfaceMarkerDemo {
    ...
    public static void main(String[] args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method targetMethod2 = object.getClass().getMethod("method2", int.class);
        int i = (int) targetMethod2.invoke(object, new Object[]{33});
        System.out.println("i: " + i);

        Method targetMethod3 = object.getClass().getMethod("method3", int.class);
